...
public class PaletteDrag : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (!TabSlot.lastDroppedOnThisFrame)
        {
            // Отвязать и вернуть на старт
            ReturnToStart();
            TabChecker.Instance.ClearPalette();
        }

        TabSlot.lastDroppedOnThisFrame = false;
    }
