...
public class PaletteDrag3 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (!TabSlot3.lastDroppedOnThisFrame)
        {
            // Отвязать и вернуть на старт
            ReturnToStart();
            TabChecker23.Instance.ClearPalette();
        }

        TabSlot3.lastDroppedOnThisFrame = false;
    }
