...
public class PaletteDrag2 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (!TabSlot2.lastDroppedOnThisFrame)
        {
            // Отвязать и вернуть на старт
            ReturnToStart();
            TabChecker22.Instance.ClearPalette();
        }

        TabSlot2.lastDroppedOnThisFrame = false;
    }
