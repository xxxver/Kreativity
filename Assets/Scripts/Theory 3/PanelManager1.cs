...
public class Theory3_2Manager : MonoBehaviour
{
    ...
    private void Start()
    {
       ...
       openButton.onClick.AddListener(() => LoadScene("Theory3-1"));
        actionButton.onClick.AddListener(() => LoadScene("Home"));  // Название сцены, на которую мы переходим
        nextSceneButton.onClick.AddListener(() => LoadScene("Theory3-3"));  // Переход на сцену theory2-2
